...
5. Specify the robotic arm model (select based on the actual model):
   ...
   - Supported models: CR3, CR5, CR7, CR10, CR12, CR16
...
5. **Key Topics**:
   ...
   - `/dobot_msgs_v3/msg/ToolVectorActual`: Cartesian position information.
